...
class CaptchaWord
{
    ...
    public function generateWord($symbols = null, $length = null, $separator = '   ')
    {
        ...
        for ($i = 0; $i <= $length - 1; $i++) { /* create the word */
            $word .= $separator . $this->defaultSymbols[$this->prng->rand(0, $lastIndexOfSymbols)];
    ...
    )
    {
        ...
        } elseif ($defaultInternalOrExternalSymbols === null) {
            include_once 'top10000.php';
